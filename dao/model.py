...
class Decoder(nn.Module):
	def __init__(self, ls_dim: int, hidden_lstm_dim: int, output_dim: int, num_layers: int = 2):
		super(Decoder, self).__init__()
		self.lstm = nn.LSTM(ls_dim, hidden_lstm_dim, num_layers=num_layers, batch_first=True, dropout=0.2)
